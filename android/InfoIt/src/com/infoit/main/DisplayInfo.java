...
public class DisplayInfo extends FragmentActivity {
  ...
  private MenuHorizontalScrollView applicationContainer;
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    applicationContainer = ShellUtil.initializeApplicationContainer(this, R.layout.ui_navigation_menu, R.layout.display_info_actions_menu, R.layout.display_info);
  ...
  private void initializeActionMenu(){
    ...
    TextView bookmarkButton = (TextView) applicationContainer.findViewById(R.id.action_display_info_bookmark_button);
