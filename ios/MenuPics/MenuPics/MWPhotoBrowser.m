...
- (void)performLayout {
    ...
    [items addObject:flexSpace];
    if (_displayActionButton) [items addObject:_deleteButton];
    [items addObject:flexSpace];
...
- (void)actionButtonPressed:(id)sender {
    ...
    NSString *textToShare = [photo caption];
    UIImage *imageToShare = [photo underlyingImage];
...
- (void)deleteButtonPressed:(id)sender {
    self.deleteSheet = [[[UIActionSheet alloc] initWithTitle:nil delegate:self
                        cancelButtonTitle:NSLocalizedString(@"Cancel", nil) destructiveButtonTitle:NSLocalizedString(@"Delete Photo", nil)
                                           otherButtonTitles:nil] autorelease];
    self.deleteSheet.actionSheetStyle = UIActionSheetStyleBlackTranslucent;
...
- (void)deletePhoto
{
    ...
    [_delegate deletePhotoFromPhotoBrowser:self];
    [self reloadData];
