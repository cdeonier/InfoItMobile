...
- (void)clearApp
{
    ...
    for (int i = 0; i < count; i++)
        [filemgr removeItemAtPath:[photosDirectory stringByAppendingPathComponent:[fileList objectAtIndex:i]] error:nil];
    ...
    if (![context save:&error]) {
        NSLog(@"Error clearing out CoreData");
    }
}
...
- (NSManagedObjectModel *)managedObjectModel
{
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"MenuPics" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"MenuPics.sqlite"];
