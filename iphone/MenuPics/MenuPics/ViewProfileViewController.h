...
@property (nonatomic, strong) IBOutlet UILabel *untaggedPhotosHeader;
@property (nonatomic, strong) IBOutlet GMGridView *untaggedPhotosGridView;
@property (nonatomic, strong) NSMutableArray *untaggedPhotos;
